...
export const metadata: Metadata = {
  title: "Rechtsanwalt München – Kanzlei Strobl | Vertragsrecht, Betreuungsrecht, Mediation",
  description: "Spezialist für Vertragsrecht, Betreuungsrecht und Mediation in München. Rechtsanwalt Gerhard Strobl bietet kompetente, diskrete rechtliche Beratung seit über 20 Jahren.",
  keywords: "Rechtsanwalt München, Vertragsrecht, Betreuungsrecht, Mediation, Kanzlei Strobl, Rechtskonsultation, Anwalt München",
  metadataBase: new URL("https://strobl-rechtsanwalt.de"),
  alternates: {
    canonical: "https://strobl-rechtsanwalt.de",
  },
  openGraph: {
    title: "Kanzlei Strobl – Juristische Kompetenz in München",
    description: "Spezialisiert auf Vertragsrecht, Betreuungsrecht und Mediation. Vertrauen Sie auf über 20 Jahre Erfahrung.",
    url: "https://strobl-rechtsanwalt.de",
    siteName: "Kanzlei Strobl",
    type: "website",
    images: [
      {
        url: "http://img.b2bpic.net/free-photo/serious-businessman-sitting-office-reading-business-reports-there-are-people-background_637285-218.jpg",
        alt: "Kanzlei Strobl – Rechtsberatung München",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Rechtsanwalt Gerhard Strobl – Kanzlei München",
    description: "Juristische Exzellenz in Vertragsrecht, Betreuungsrecht und Mediation.",
    images: ["http://img.b2bpic.net/free-photo/serious-businessman-sitting-office-reading-business-reports-there-are-people-background_637285-218.jpg"],
  },
  robots: {
    index: true,
    follow: true,
